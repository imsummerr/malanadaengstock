...
var ITEM_EXPIRY_DAYS = {
  ...
  'สันคอสไลซ์': 3, 'หมูสามชั้นสไลซ์': 3, 'สันนอกสไลซ์': 3, 'สะโพกหมูสไลซ์': 3,
  'หัวไหล่หมูติดหนังสไลซ์': 3, 'หัวไหล่หมูติดหนังหั่นชิ้น': 3,
  'อกไก่เนื้อล้วนติดหนัง': 3,
  // หมูซื้อมาหั่นเสร็จแล้ว ของดิบก็เป็นเนื้อสด อยู่ได้ 3 วันเท่ากัน
  'สันคอสไลซ์ (ดิบ)': 3, 'หมูสามชั้นสไลซ์ (ดิบ)': 3, 'สันนอกสไลซ์ (ดิบ)': 3,
  'สะโพกหมูสไลซ์ (ดิบ)': 3, 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)': 3,
  'หัวไหล่หมูติดหนังหั่นชิ้น (ดิบ)': 3, 'อกไก่เนื้อล้วนติดหนัง (ดิบ)': 3,
  'อกไก่ (ดิบ)': 3,
