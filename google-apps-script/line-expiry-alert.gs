...
var ITEM_EXPIRY_DAYS = {
  ...
  // ชื่อใหม่ลงท้ายด้วย "สไลซ์" ชื่อเก่า "สไลด์" เก็บไว้ด้วย เผื่อแถวเก่าในชีตประวัติ
  'สันคอสไลซ์': 3, 'สามชั้นสไลซ์': 3, 'สันนอกสไลซ์': 3, 'สะโพกหมูสไลซ์': 3,
  'หัวไหล่หมูสไลซ์': 3, 'หัวไหล่หมูสไลซ์ (ไม้)': 3, 'หัวไหล่หมูสไลซ์ (ถุง)': 3,
  'หัวไหล่หมูติดหนังสไลซ์': 3,
  'สันคอสไลด์': 3, 'สามชั้นสไลด์': 3, 'หัวไหล่หมูสไลด์': 3, 'สันนอก': 3,
  'หมูห่อชีส': 3, 'สามชั้นพันเห็ดเข็มทอง': 3, 'สามชั้นพันสาหร่าย': 3,
  'หมูพันเห็ดเข็มทอง': 3, 'หมูพันสาหร่าย': 3, 'หมูพันเห็ดชิเมจิ': 3, 'หมูพันผักกาดขาว': 3,
  'อกไก่': 3, 'อกไก่ (โล)': 3, 'สันคอสไลด์': 3,
  'สะโพกหมูสไลด์': 3, 'หัวไหล่หมูติดหนังหั่นชิ้น': 3,
  'หัวไหล่หมูติดหนังสไลด์': 3, 'อกไก่เนื้อล้วนติดหนัง': 3, 'สามชั้นสไลด์': 3,
  'สันนอกสไลด์': 3,
  'สามชั้นพันปูอัด': 3,
  'เนื้อแดง': 3, 'สันนอกห่อชีส': 3, 'สามชั้นพันเห็ดเข็ม': 3,   // ชื่อเก่า
  // ── 7 วัน ──
  'ดอลลี่': 7,
...
var NO_EXPIRY_EXACT = {
  ...
  'นมข้นจืด': 1, 'ตะเกียบ': 1, 'กระดูกหมู': 1,
