...
var INTAKE_ALIAS = {
  ...
  'สันคอ': 'สันคอ (ดิบ)', 'หมูสันคอ': 'สันคอ (ดิบ)', 'คอหมู': 'สันคอ (ดิบ)',
  // ซื้อหมูสามชั้นมาคือเนื้อดิบ จะเอาไปพันหรือสไลด์ก็ได้ ไม่ใช่ของที่พันเสร็จแล้ว
  'สามชั้น': 'หมูสามชั้น (ดิบ)', 'หมูสามชั้น': 'หมูสามชั้น (ดิบ)',
  'สามชั้นสไลด์': 'หมูสามชั้น (ดิบ)', 'สามชั้นสไลซ์': 'หมูสามชั้น (ดิบ)',
  'สะโพกหมูสไลด์': 'สะโพกหมู (ดิบ)',
  'หัวไหล่': 'หัวไหล่หมู (ดิบ)', 'หัวไหล่หมู': 'หัวไหล่หมู (ดิบ)',
  'สันนอก': 'สันนอก (ดิบ)', 'อก': 'อกไก่ (ดิบ)', 'อกไก่สไลซ์': 'อกไก่ (ดิบ)',
  ...
  'สามชั้นไม้': 'หัวไหล่หมูสไลซ์ (ไม้)', 'หมูไม้': 'สันนอกสไลซ์',
  ...
  'หัวไหล่เสียบไม้': 'หัวไหล่หมูสไลซ์ (ไม้)',
  'หัวไหล่หมูไม้': 'หัวไหล่หมูสไลซ์ (ไม้)',
  ...
  'ฟองสามเหลี่ยม': 'ฟองเต้าหู้สามเหลี่ยม', 'ไก่': 'อกไก่',
  ...
  'สะโพก': 'สะโพกหมู (ดิบ)', 'สะโพกหมู': 'สะโพกหมู (ดิบ)',
  'สะโพกหมูสไลซ': 'สะโพกหมู (ดิบ)', 'สะโพกหมูสไลด์': 'สะโพกหมู (ดิบ)',
  // ติดหนังกับไม่ติดหนังคือเนื้อก้อนเดียวกัน เข้าของดิบตัวเดียวกัน
  'หัวไหล่ติดหนัง': 'หัวไหล่หมู (ดิบ)', 'หัวไหล่หมูติดหนัง': 'หัวไหล่หมู (ดิบ)',
  'หมูติดหนัง': 'หัวไหล่หมู (ดิบ)',
