...
function intakeOnText_(ev, ctx) {
  ...
  if (quiet && mode !== 'all') {
    ...
    items = items.filter(function (it) {
      if (intakeConfident_(it, names)) return true;
      skipped.push(it.raw);       // ข้ามไป แต่ต้องบอกให้รู้ ไม่ใช่หายเงียบ
      return false;
    });
  }
  ...
  intakeReply_(ctx, intakeSaveAndSummarize_(items, ctx, 'ข้อความ', raw, skipped));
}
...
var INTAKE_UNIT_RE =
  ...
  '|บาท|฿|บ\\.|thb|baht' +
  // "แพ้ค" กับ "แพ๊ค" สะกดผิดกันประจำ ไม่รับไว้ตรงนี้ เลขจะกลายเป็น "หน่วย"
...
function intakeConfident_(it, names) {
  ...
  // บอกหน่วยของมาพร้อมราคา ("มันฝรั่ง 0.5 โล 10") = ลงรายการซื้อแน่ ๆ
  // คนคุยกันไม่พิมพ์ทั้งหน่วยชั่งตวงและราคาในประโยคเดียว
  // ไม่งั้นของที่ยังไม่มีในชีตและไม่ได้พิมพ์คำว่า "บาท" จะหายไปเงียบ ๆ
  if (it.saidUnit && it.baht > 0) return true;
...
var INTAKE_ALIAS = {
  // เนื้อสัตว์ — ซื้อเป็นโล ระบบจะพาไปเข้า "(โล)" ให้เองตามหน่วยที่พิมพ์
  'สลีปดอลลี่': 'ดอลลี่', 'สไลด์ดอลลี่': 'ดอลลี่', 'สไลซ์ดอลลี่': 'ดอลลี่',
  'ปลาดอลลี่': 'ดอลลี่', 'ปลาสไลด์': 'ดอลลี่',
  // หมูซื้อมาหั่นเสร็จแล้ว ของดิบเลยลงท้ายว่าสไลซ์เหมือนกัน
  'สันคอ': 'สันคอสไลซ์ (ดิบ)', 'หมูสันคอ': 'สันคอสไลซ์ (ดิบ)',
  'คอหมู': 'สันคอสไลซ์ (ดิบ)', 'สันคอสไลซ์': 'สันคอสไลซ์ (ดิบ)',
  'สามชั้น': 'หมูสามชั้นสไลซ์ (ดิบ)', 'หมูสามชั้น': 'หมูสามชั้นสไลซ์ (ดิบ)',
  'สามชั้นสไลด์': 'หมูสามชั้นสไลซ์ (ดิบ)', 'สามชั้นสไลซ์': 'หมูสามชั้นสไลซ์ (ดิบ)',
  'หมูสามชั้นสไลซ์': 'หมูสามชั้นสไลซ์ (ดิบ)',
  'สันนอก': 'สันนอกสไลซ์ (ดิบ)', 'สันนอกสไลซ์': 'สันนอกสไลซ์ (ดิบ)',
  'อก': 'อกไก่เนื้อล้วนติดหนัง (ดิบ)',
  'อกไก่': 'อกไก่เนื้อล้วนติดหนัง (ดิบ)',
  'อกไก่สไลซ์': 'อกไก่เนื้อล้วนติดหนัง (ดิบ)',
  'หมึกกรอบ': 'ปลาหมึกกรอบ',
  // เห็ด
  'เข็มทอง': 'เห็ดเข็ม', 'เห็ดเข็มทอง': 'เห็ดเข็ม',
  'ออรินจิ': 'เห็ดออเร็นจิ', 'เห็ดออรินจิ': 'เห็ดออเร็นจิ',
  'หูหนู': 'เห็ดหูหนู', 'เห็ดหูหนูขาว': 'เห็ดหูหนู',
  // ผัก
  'ผักกาด': 'ผักกาดขาว',
  // เต้าหู้ / ลูกชิ้น
  'เต้าหู้ชีส': 'เต้าชีส', 'ชีสหลายสี': 'หลายสี',
  'ปลาแผ่น': 'เต้าหู้ปลาแผ่น', 'แผ่นยาว': 'เต้าหู้ปลาแผ่น',
  'สามชั้นไม้': 'หัวไหล่หมูติดหนังสไลซ์', 'หมูไม้': 'สันนอกสไลซ์',
  // เขียนเต็มว่า "เสียบไม้" = ของที่เสียบเสร็จแล้ว ไม่ใช่เนื้อดิบ
  // ต้องมาก่อน 'หัวไหล่หมู' ที่ชี้ไปของดิบ ไม่งั้นจะเข้าผิดชั้น
  'หัวไหล่หมูเสียบไม้': 'หัวไหล่หมูติดหนังสไลซ์',
  'หัวไหล่เสียบไม้': 'หัวไหล่หมูติดหนังสไลซ์',
  'หัวไหล่หมูไม้': 'หัวไหล่หมูติดหนังสไลซ์',
  'สันนอกเสียบไม้': 'สันนอกสไลซ์', 'สันนอกไม้': 'สันนอกสไลซ์',
  'พันชิเมจิ': 'หมูพันเห็ดชิเมจิ', 'หมูพันชิเมจิ': 'หมูพันเห็ดชิเมจิ',
  'สามชั้นพันชิเมจิ': 'หมูพันเห็ดชิเมจิ',
  'พันกาดขาว': 'หมูพันผักกาดขาว', 'สามชั้นพันผักกาดขาว': 'หมูพันผักกาดขาว',
  'พันผักกาดขาว': 'หมูพันผักกาดขาว',
  'พันเห็ด': 'หมูพันเห็ดเข็มทอง', 'พันเห็ดเข็ม': 'หมูพันเห็ดเข็มทอง',
  'พันสาหร่าย': 'หมูพันสาหร่าย', 'เบคอนพัน': 'เบคอนพันไส้กรอก',
  'กรอกชีส': 'ไส้กรอกชีส', 'กรอกเล็ก': 'ไส้กรอกอันเล็ก',
  'เต้าหมู': 'เต้าหู้หมู', 'เต้าหลอด': 'เต้าหู้หลอด', 'เต้าเหลี่ยม': 'เต้าหู้ปลา',
  'กาดขาว': 'ผักกาดขาว', 'บุ้ง': 'ผักบุ้ง', 'ออเร็น': 'เห็ดออเร็นจิ',
  'ออเร็นจิ': 'เห็ดออเร็นจิ', 'หูหนูขาว': 'เห็ดหูหนู', 'หมึกกรอบ': 'ปลาหมึกกรอบ',
  'ฟองสามเหลี่ยม': 'ฟองเต้าหู้สามเหลี่ยม',
  'ไก่': 'อกไก่เนื้อล้วนติดหนัง (ดิบ)',
  'เต้าหู้ปลาสี่เหลี่ยม': 'เต้าหู้ปลา', 'เต้าเหลี่ยม': 'เต้าหู้ปลา',
  // เส้น
  'เส้นมันเทศ': 'มันเทศ', 'เส้นอุด้ง': 'อุด้ง', 'วุ้นเส้น': 'วุ้นเส้นหม่าล่า',
  'แป้งต็อก': 'ต็อกแท่งเล็ก', 'ต็อก': 'ต็อกแท่งเล็ก',
  'มาม่าส้ม': 'มาม่า 35 ส้ม', 'มาม่า35ส้ม': 'มาม่า 35 ส้ม',
  'มาม่าชมพู': 'มาม่า 35 ชมพู', 'มาม่า35ชมพู': 'มาม่า 35 ชมพู',
  'ฟองม้วน': 'ฟองเต้าหู้ม้วน', 'ฟองเต้าหู้': 'ฟองเต้าหู้ม้วน',
  // ชิ้นส่วนหมูที่เพิ่มมาใหม่ — ซื้อมาเป็นโล เข้าเป็นของดิบ
  'สะโพก': 'สะโพกหมูสไลซ์ (ดิบ)', 'สะโพกหมู': 'สะโพกหมูสไลซ์ (ดิบ)',
  'สะโพกหมูสไลซ': 'สะโพกหมูสไลซ์ (ดิบ)', 'สะโพกหมูสไลด์': 'สะโพกหมูสไลซ์ (ดิบ)',
  'สะโพกหมูสไลซ์': 'สะโพกหมูสไลซ์ (ดิบ)',
  // หัวไหล่ซื้อมา 2 แบบ สไลซ์กับหั่นชิ้น เป็นคนละของดิบ คนละต้นทุน
  // พิมพ์ว่า "หั่นชิ้น" มาถึงจะเข้าตัวหั่นชิ้น ที่เหลือเข้าตัวสไลซ์
  // (สไลซ์ซื้อบ่อยกว่ามาก เลยให้เป็นตัวตั้งต้น แต่บอทตอบชื่อเต็มกลับไปเสมอ)
  'หัวไหล่หมูหั่นชิ้น': 'หัวไหล่หมูติดหนังหั่นชิ้น (ดิบ)',
  'หัวไหล่หั่นชิ้น': 'หัวไหล่หมูติดหนังหั่นชิ้น (ดิบ)',
  'หัวไหล่หมูติดหนังหั่นชิ้น': 'หัวไหล่หมูติดหนังหั่นชิ้น (ดิบ)',
  'หมูหั่นชิ้น': 'หัวไหล่หมูติดหนังหั่นชิ้น (ดิบ)',
  'หัวไหล่': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หัวไหล่หมู': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หัวไหล่หมูสไลซ์': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หัวไหล่หมูสไลด์': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หัวไหล่สไลซ์': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หัวไหล่ติดหนัง': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หัวไหล่หมูติดหนัง': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หัวไหล่หมูติดหนังสไลซ์': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'หมูติดหนัง': 'หัวไหล่หมูติดหนังสไลซ์ (ดิบ)',
  'อกไก่ติดหนัง': 'อกไก่เนื้อล้วนติดหนัง (ดิบ)',
  'ไก่ติดหนัง': 'อกไก่เนื้อล้วนติดหนัง (ดิบ)',
  'วุ้นเส้นเกาหลี': 'วุ้นเส้นเกาหลี (ดิบ)', 'เส้นเกาหลี': 'วุ้นเส้นเกาหลี (ดิบ)',
  // ซื้อน้ำจิ้มมาคือของดิบ ยังไม่ได้เทใส่กระปุก
  // ซื้อเข้าครัวกลางคือนมผง ส่วนนมข้นจืดคือของที่ชงแล้ว ไม่ได้ซื้อมา
  'นม': 'นมผง', 'นมสด': 'นมผง',
  'น้ำจิ้มงา': 'น้ำจิ้มงา (ดิบ)', 'จิ้มงา': 'น้ำจิ้มงา (ดิบ)',
  'น้ำจิ้มสุกี้': 'น้ำจิ้มสุกี้ (ดิบ)', 'จิ้มสุกี้': 'น้ำจิ้มสุกี้ (ดิบ)',
  'คนอร์': 'ซุปก้อน', 'คนอร์ซุปก้อน': 'ซุปก้อน', 'ซุปก้อนคนอร์': 'ซุปก้อน',
  'กะหล่ำปลี': 'กะหล่ำ', 'หล่ำ': 'กะหล่ำ',
...
function intakeStockQty_(item, counts, gram) {
  ...
  //
  // ยกเว้นของดิบที่ซื้อยกแพ็คแล้วนับย่อยได้อีกชั้น (ฟองเต้าหู้ม้วน มาม่า 35)
  // พวกนี้ต้องให้ตัวจับคู่หน่วยข้างล่างทำงาน ไม่งั้น "22 แพ็ค" จะกลายเป็น
  // 22 อัน แทนที่จะเป็น 264 อัน
  if (item.kind === 'วัตถุดิบ' && !(item.perPack > 1)) {
 ...
 */
function intakeSaveAndSummarize_(items, ctx, source, rawText, skipped) {
  ...
  try {
    ...
    for (i = 0; i < items.length; i++) {
      ...
      if (it.expense || intakeLooksLikeExpense_(it, names)) {
        ...
        // จับชื่อได้แต่ไม่มีในชีต = ตารางชื่อเล่นชี้ไปที่ของที่ถูกลบ/เปลี่ยนชื่อไปแล้ว
        // ต้องข้ามไปแล้วบอก ไม่ใช่ปล่อยให้พังทั้งข้อความ
        if (hit.matched && !byName[hit.name]) {
        ...
        if (makeOnly) {
          ...
          var uTyped = (it.counts && it.counts.length)
  ...
  // บรรทัดที่อ่านออกว่าเป็นของ แต่ไม่มั่นใจพอเลยไม่บันทึก
  // ต้องบอกเสมอ ไม่งั้นยอดรวมขาดไปโดยไม่มีใครรู้ว่าขาดตรงไหน
  if (skipped && skipped.length) {
    msg += '\n\n⚠️ ข้ามไป ' + skipped.length + ' บรรทัด ไม่แน่ใจว่าเป็นของที่ซื้อ\n' +
           skipped.map(function (n) { return '• ' + n; }).join('\n') +
           '\nถ้าใช่ พิมพ์ใหม่พร้อมคำว่า "บาท" ต่อท้ายราคา';
  }
