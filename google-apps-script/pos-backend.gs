...
var RAW_KG = [
  ...
  'สาหร่าย'
  // เห็ดชิเมจิ ซื้อเป็นห่อ ไม่ได้ชั่ง เลยไม่อยู่ในนี้
];
var RAW_BAG = { 'เห็ดชิเมจิ': 'ห่อ', 'มันเทศ': 'อัน',
 ...
 */
var RAW_GROUPS = {
  'เนื้อหมู': ['หมูสามชั้น', 'สันคอ', 'สันนอก', 'หัวไหล่หมู', 'สะโพกหมู']
};
var RAW_GROUP_MARK = '@';
...
var STICK_ITEMS = [
  ...
  ['สันนอกสไลซ์',         ['สันนอก'],    ''],
  ['สามชั้นสไลซ์',         ['หมูสามชั้น'], ''],
  ['สะโพกหมูสไลซ์',        ['สะโพกหมู'],  ''],
  // ติดหนังกับไม่ติดหนังคือเนื้อก้อนเดียวกัน แค่หั่นคนละแบบ ใช้ของดิบร่วมกัน
  ['หัวไหล่หมูติดหนังสไลซ์',   ['หัวไหล่หมู'], ''],
  ['หัวไหล่หมูติดหนังหั่นชิ้น', ['หัวไหล่หมู'], ''],
  ['อกไก่เนื้อล้วนติดหนัง',    ['อกไก่'],      ''],
  ['หัวไหล่หมูสไลซ์ (ไม้)', ['หัวไหล่หมู'], 'ของเดียวกับแบบถุง แต่คนละวิธีแพ็ค นับแยกกัน'],
  ['อกไก่',               ['อกไก่'],      ''],
  ['ดอลลี่',              '',            ''],
  ['แมงกะพรุน',           '',            ''],
  ['ปลาหมึกกรอบ',         '',            ''],
...
var BAG_ITEMS = [
  ['สันคอสไลซ์',           ['สันคอ'],      ''],
  ['หัวไหล่หมูสไลซ์ (ถุง)', ['หัวไหล่หมู'], 'ของเดียวกับแบบไม้ แต่คนละวิธีแพ็ค นับแยกกัน'],
  ['ผักกาดขาว',            '',             ''],
  ['ผักบุ้ง',               '',             ''],
  ['กวางตุ้ง',              '',             ''],
  ['กะหล่ำ',                '',             ''],
...
var ITEM_RENAME = {
  ...
  'สามชั้นไม้':          'หัวไหล่หมูสไลซ์ (ไม้)',
  'หมูไม้':              'สันนอกสไลซ์',
  'หัวไหล่หมูเสียบไม้':   'หัวไหล่หมูสไลซ์ (ไม้)',
  ...
  'สามชั้นสไลด์':         'สามชั้นสไลซ์',
  'สันนอกสไลด์':         'สันนอกสไลซ์',
  'สันนอกไลซ์':          'สันนอกสไลซ์',
  'สันคอสไลด์':          'สันคอสไลซ์',
  'หัวไหล่หมูสไลด์ (ไม้)': 'หัวไหล่หมูสไลซ์ (ไม้)',
  'หัวไหล่หมูสไลด์ (ถุง)': 'หัวไหล่หมูสไลซ์ (ถุง)',
  'หัวไหล่หมูติดหนังสไลด์': 'หัวไหล่หมูติดหนังสไลซ์',
  // ติดหนังกับไม่ติดหนังใช้เนื้อก้อนเดียวกัน ของดิบที่เคยแยกไว้ยุบมารวม
  'หัวไหล่หมูติดหนัง (ดิบ)': 'หัวไหล่หมู (ดิบ)',
