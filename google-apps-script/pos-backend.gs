...
var FILL_ITEMS = [
  ...
  // ชงจากนมผง อัตราส่วนไม่คงที่ เลยให้กรอกเองว่าใช้นมผงไปกี่โล
  // ครัวกลางถือนมผง สาขาถือนมข้นจืด คนละชื่อเพราะคนละสภาพของ
  ['นมข้นจืด', 'ลิตร', ['นมผง'], 0, 'ชงจากนมผง — กรอกว่าใช้นมผงไปกี่โล']
];
...
var SUPPLY_ITEMS = [
  ...
  ['นมผง',          'กก.',  SCOPE_CENTRAL, 1,  'ถุง',
   'ชั่งเป็นโลมาลง — ถุงละกี่โลแก้ช่อง "หน่วยย่อยต่อแพ็ค" ในชีตได้'],
