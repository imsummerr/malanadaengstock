 ...
 */
var FILL_ITEMS = [
  ['น้ำจิ้มงา (กระปุก)',   'กระปุก', ['น้ำจิ้มงา', 'ถ้วย 2 ออน'],   0, 'เทจากถุงใส่กระปุก'],
  ['น้ำจิ้มสุกี้ (กระปุก)', 'กระปุก', ['น้ำจิ้มสุกี้', 'ถ้วย 2 ออน'], 0, 'เทจากแกลลอนใส่กระปุก']
];
...
function itemCatalogue_() {
  ...
  // ของที่เทใส่ภาชนะ — วัตถุดิบชี้ไปที่ของใช้ที่มีอยู่แล้ว ไม่ต้องงอกของดิบใหม่
