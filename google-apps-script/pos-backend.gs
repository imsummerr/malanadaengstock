...
var PACK_SIZE_EXCEPTION = {
  ...
  'หม่าล่า(ผสมแล้ว)': 1,
  // ส่งสาขาเป็นถุง ถุงละ 1 ลิตร — ถุงใหญ่/เล็กกว่านี้แก้ในชีตได้
  'นมข้นจืด': 1000
};
...
var FILL_ITEMS = [
  ...
  // ชงนมผง 1 กรัม ต่อน้ำร้อน 3 มล. → ได้ 4 มล. เลยตัดนมผง 0.25 กรัมต่อ 1 มล.
  // ครัวกลางถือนมผง สาขาถือนมข้นจืด คนละชื่อเพราะคนละสภาพของ
  ['นมข้นจืด', 'มล.', ['นมผง x0.25'], 0,
   'ชง นมผง 1 กรัม : น้ำร้อน 3 มล. — กรอกแค่ว่าได้กี่ มล.']
];
