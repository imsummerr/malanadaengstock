...
var RAW_KG = [
  ...
  'สะโพกหมู', 'หัวไหล่หมูติดหนัง', 'อกไก่ติดหนัง',
...
var STICK_ITEMS = [
  ...
  ['สันนอกสไลด์',         ['สันนอก'],    ''],
  ['สามชั้นสไลด์',         ['หมูสามชั้น'], ''],
  ['สะโพกหมูสไลด์',        ['สะโพกหมู'],  ''],
  // ติดหนังเป็นคนละชิ้นส่วนกับหัวไหล่หมูธรรมดา ราคาต่อโลคนละราคา จึงแยกของดิบ
  // สองตัวนี้มาจากเนื้อก้อนเดียวกัน แค่หั่นคนละแบบ จึงใช้ของดิบร่วมกัน
  ['หัวไหล่หมูติดหนังสไลด์',   ['หัวไหล่หมูติดหนัง'], ''],
  ['หัวไหล่หมูติดหนังหั่นชิ้น', ['หัวไหล่หมูติดหนัง'], ''],
  ['อกไก่เนื้อล้วนติดหนัง',    ['อกไก่ติดหนัง'],      ''],
...
var ITEM_RENAME = {
  ...
  'สะโพกหมูสไลซ':        'สะโพกหมูสไลด์',
  'สะโพกหมูสไลซ์':       'สะโพกหมูสไลด์',
  'สามชั้นสไลซ์':         'สามชั้นสไลด์',
  'สันนอกสไลซ์':         'สันนอกสไลด์',
  'สันนอกไลซ์':          'สันนอกสไลด์',
  'สันคอสไลซ์':          'สันคอสไลด์',
  'หัวไหล่หมูติดหนังสไลซ์': 'หัวไหล่หมูติดหนังสไลด์'
